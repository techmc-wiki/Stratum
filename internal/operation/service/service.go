...
func (s *Service) audit(ctx context.Context, value operation.Operation, action string) error {
	...
	for _, key := range []string{"selectedRuntimeProfileId", "artifactCheckEnabled", "stagingReadinessStatus", "appliedVerifyStatus", "totalApplied", "validApplied", "missingApplied", "corruptedApplied", "artifactReadinessIssues", "restartStopStatus", "restartStartAttempted", "runtimeReadinessStatus", "runtimeReadinessReady", "runtimeReadinessIssues", "runtimeReadinessProcessState", "runtimeReadinessEnvironmentManifestExists", "runtimeReadinessAppliedTotal", "runtimeReadinessAppliedValid", "runtimeReadinessAppliedMissing", "runtimeReadinessAppliedCorrupted", "runtimeReadinessAppliedError"} {
